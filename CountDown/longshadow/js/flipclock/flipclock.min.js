...
(function (e) {
    ...
    FlipClock.Time = FlipClock.Base.extend({
        ...
        getDayCounter: function () {
            var e = this.digitize([this.getdias(), this.gethoras(!0), this.getminutos(!0), this.getsegundos(!0)]);
            return e
        },
        getdias: function (e) {
        ...
        getHourCounter: function () {
            var e = this.digitize([this.gethoras(), this.getminutos(!0), this.getsegundos(!0)]);
            return e
        },
        getHourly: function () {
        ...
        getMilitaryTime: function () {
            var e = new Date,
                t = this.digitize([e.gethoras(), e.getminutos(), e.getsegundos()]);
            return t
        },
        getminutos: function (e) {
            var t = this.time / 60;
            e && (t %= 60);
            return Math.floor(t)
        },
        getMinuteCounter: function () {
            var e = this.digitize([this.getminutos(!0), this.getsegundos(!0)]);
            return e
        },
        getsegundos: function (e) {
            var t = this.time;
            e && (t == 60 ? t = 0 : t %= 60);
            return Math.ceil(t)
        },
        getTime: function () {
            var e = new Date,
                t = e.gethoras(),
                n = t > 12 ? "PM" : "AM",
                r = this.digitize([t > 12 ? t - 12 : t === 0 ? 12 : t, e.getminutos(), e.getsegundos()]);
            return r
        },
        getWeeks: function () {
...
(function (e) {
    FlipClock.HourlyCounterFace = FlipClock.Face.extend({
        ...
        build: function (t, n) {
            ...
            e(this.createDivider("segundos")).insertBefore(this.factory.lists[this.factory.lists.length - 2].$obj);
            e(this.createDivider("minutos")).insertBefore(this.factory.lists[this.factory.lists.length - 4].$obj);
            t || e(this.createDivider("horas", !0)).insertBefore(this.factory.lists[0].$obj);
...
(function (e) {
    FlipClock.TwelveHourClockFace = FlipClock.TwentyFourHourClockFace.extend({
        ...
        _getMeridium: function () {
            return (new Date).gethoras() >= 12 ? "PM" : "AM"
        },
        _isPM: function () {
...
(function (e) {
    FlipClock.DailyCounterFace = FlipClock.Face.extend({
        ...
        build: function (t, n) {
            ...
            e(this.createDivider("segundos")).insertBefore(this.factory.lists[this.factory.lists.length - 2].$obj);
            e(this.createDivider("minutos")).insertBefore(this.factory.lists[this.factory.lists.length - 4].$obj);
            e(this.createDivider("horas", !0)).insertBefore(this.factory.lists[this.factory.lists.length - 6].$obj);
            e(this.createDivider("dias", !0)).insertBefore(this.factory.lists[0].$obj);
            this._clearExcessDigits();
            this.autoStart && this.start()
        },
        flip: function (e, t) {
