...
<body>
	...
	<!--//header-->
			...
			<div class="inner_content">
				...
				<div class="row">
					<div class="span4">
					<h3>Do you need a website, have a question or comment?</h3> <p>Please feel free to send us an email or fill in our handy contact form. We aim to reply within 24 hours.</p>
