            ...
            <div class="col-md-12">
               ...
               <div class="portlet box red">
                  <div class="portlet-title">
                     <div class="caption"><i class="icon-picture"></i>Álbum</div>
                  </div>
								...
								<div class="form-body">
								   ...
								   <div class="form-group">
									  ...
									  <div class="col-md-8">
										<?php 
											$torneoid = $_GET['id'];
											$sql = "SELECT nombre, titulo FROM album WHERE id = '$torneoid'";
			  ...
			  <!-- END FORM-->
				  ...
				  <script type="text/javascript">
					function enviarFormTorneo(){
					  ...
					  $.ajax({
						url:'actualizaralbum.php', //Url a donde la enviaremos
