							...
							if ($consulta){
								...
								?>
									<tr class="odd gradeX">
									  ...
									  <td><a href="editarsponsors.php?id=<?php echo $sponsor['id'];?>">Editar</a></td>
									  <td><a href="editarsponsors.php?id=<?php echo $sponsor['id'];?>">Borrar</a></td>
								    </tr>
								<?php 
								}
							}else{
