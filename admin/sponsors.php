            ...
            <div class="col-md-12">
               ...
               <div class="portlet box red">
                  <div class="portlet-title">
                     <div class="caption"><i class="icon-dollar"></i>Sponsors</div>
                  </div>
                  <div class="portlet-body">
                     <div class="table-toolbar">

						<div class="btn-group">
                           <a class="btn blue" data-toggle="modal" href="#sponsor">
                           Agregar Sponsor <i class="icon-plus"></i>
                           </a>
                        </div>
                     </div>
                     <table class="table table-striped table-bordered table-hover" id="tabla_lugares">
                        ...
                        <tbody>
							<?php 
							$sql = "SELECT nombre, id FROM sponsor";
				  ...
				  <!-- MODAL sponsor -->
				  <div class="modal fade" id="sponsor" tabindex="-1" role="sponsor" aria-hidden="true">
